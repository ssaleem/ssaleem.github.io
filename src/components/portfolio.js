				...
				<main>
					...
					<div className="container">
						{projects.map( project => ( project.tags.includes(this.allSkills[this.state.selection]) && (
							...
							<p className="proj-links">{project.demoUrl && <a href={project.demoUrl} rel="noopener noreferrer" target="_blank">DEMO</a>}{project.demoUrl && <span> | </span>}<a href={project.codeUrl} rel="noopener noreferrer" target="_blank">CODE</a></p>
